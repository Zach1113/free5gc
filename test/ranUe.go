...
func GetEAPAKAPrimeAuthSubscription(k, opc, op string) models.Udr_DR_AuthenticationSubscription {
	var authSubs models.Udr_DR_AuthenticationSubscription
	authSubs.EncPermanentKey = k
	authSubs.EncOpcKey = opc
	authSubs.AuthenticationManagementField = "8000"
...
func NewRanUeContext(supi string, ranUeNgapId int64, cipheringAlg ie.AlgCiphering,
	integrityAlg ie.AlgIntegrity, AnType models.AccessType) *RanUeContext {
	ue := RanUeContext{}
...
func (ue *RanUeContext) DeriveRESstarAndSetKey(
	authSubs models.Udr_DR_AuthenticationSubscription, rand []byte, snName string) []byte {
...
func (ue *RanUeContext) DeriveResEAPMessageAndSetKey(
	authSubs models.Udr_DR_AuthenticationSubscription, eAPMessage []byte, snName string) []byte {
